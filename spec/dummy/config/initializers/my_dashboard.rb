...
MyDashboard.configure do |config|
  ...
  #
  # config.widgets_views_path = 'app/views/my_dashboard/widgets/'
  # config.widgets_js_path    = 'app/assets/javascripts/my_dashboard'
  # config.widgets_css_path   = 'app/assets/stylesheets/my_dashboard'
  ...
  # config.dashboards_views_path = 'app/views/my_dashboard/dashboards/'

  # The MyDashboard layout used to display metrics.
  # config.dashboard_layout_path = 'my_dashboard/dashboard'

  # Default dashboard name to load when going to /my_dashoboard/dashboards
